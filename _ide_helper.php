 ...
 * Generated for Laravel 5.6.16 on 2018-04-07 17:31:39.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Auth {
        ...
        {
            return \App\Auth\CrmkaGuard::user();
        }
        ...
        {
            return \App\Auth\CrmkaGuard::onceUsingId($id);
        }
        ...
        {
            return \App\Auth\CrmkaGuard::validate($credentials);
        }
        ...
        {
            return \App\Auth\CrmkaGuard::attempt($credentials);
        }
        ...
        {
            return \App\Auth\CrmkaGuard::authenticate();
        }
        ...
        {
            return \App\Auth\CrmkaGuard::check();
        }
        ...
        {
            return \App\Auth\CrmkaGuard::guest();
        }
        ...
        {
            return \App\Auth\CrmkaGuard::setUser($user);
        }
        ...
        {
            return \App\Auth\CrmkaGuard::getProvider();
        }
        ...
        {
            \App\Auth\CrmkaGuard::setProvider($provider);
        }
